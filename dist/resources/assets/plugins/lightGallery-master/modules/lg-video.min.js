...
!function (a, b) {
  ...
  !function () {
    ...
    var b = { videoMaxWidth: "855px", youtubePlayerParams: !1, vimeoPlayerParams: !1, dailymotionPlayerParams: !1, vkPlayerParams: !1, videojs: !1, videojsOptions: {} },
        c = function c(_c) {
      return this.core = a(_c).data("lightGallery"), this.$el = a(_c), this.core.s = a.extend({}, b, this.core.s), this.videoLoaded = !1, this.init(), this;
      ...
      var b = this;b.core.$el.on("hasVideo.lg.tm", function (a, c, d, e) {
        ...
        var d = b.core.$slide.eq(c).find(".lg-video-cont");d.hasClass("lg-has-iframe") || (d.css("max-width", b.core.s.videoMaxWidth), b.videoLoaded = !0);
      });var c = function c(a) {
...
//# sourceMappingURL=lg-video.min.js.map