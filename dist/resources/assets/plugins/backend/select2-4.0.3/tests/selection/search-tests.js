...
test('updating selection does not shift the focus', function (assert) {
  ...
  assert.equal(document.activeElement, $search[0], 'The search did not have focus originally');
...
test('the focus event shifts the focus', function (assert) {
  ...
  assert.notEqual(document.activeElement, $search[0], 'The search had focus originally');
...
//# sourceMappingURL=search-tests.js.map