...
!function (a, b) {
  ...
  !function () {
    ...
    var b = { pager: !1 },
        c = function c(_c) {
      return this.core = a(_c).data("lightGallery"), this.$el = a(_c), this.core.s = a.extend({}, b, this.core.s), this.core.s.pager && this.core.$items.length > 1 && this.init(), this;
...
//# sourceMappingURL=lg-pager.min.js.map