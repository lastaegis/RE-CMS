...
!function (a, b) {
  ...
  !function () {
    ...
    var b = { hash: !0 },
        c = function c(_c) {
      return this.core = a(_c).data("lightGallery"), this.core.s = a.extend({}, b, this.core.s), this.core.s.hash && (this.oldHash = window.location.hash, this.init()), this;
...
//# sourceMappingURL=lg-hash.min.js.map